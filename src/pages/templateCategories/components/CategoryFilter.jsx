...
const CategoryFilter = ({ searchParams, currentPage, setSearchParams }) => {
  ...
  return (
    <form
      ...
      className="grid-cols-[1fr_auto] grid w-full min-h-[36px] mt-1 rounded py-1 bg-white items-center gap-4 text-sm font-medium"
    >
      <CustomInput
